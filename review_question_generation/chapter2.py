chapter = [{"topic": "Forces between Atoms, Ions, and Molecules", "text": """There are two types of forces that exist between individual atoms, ions,
...
biological function and much of the behavior of matter."""}, 
{"topic": "Energy and force", "text": """Phenomena that occur on the nanoscale arise from a few guiding
...
than when the same species are confined. Differences in potential energies of states lead to physical forces
...
goal by the end of this book is to make it make sense. It's worth taking a closer look at what we mean by energy and force. In
...
than how fast its pieces are moving. The potential energy of a system is equal to the work needed (positive
...
{"topic": "Electrostatic interactions", "text": """Let's make these broad statements more concrete: Say you have two
charged particles. They could be made of plastic, metal, or rock, or
even single ions, like Na$^{+}$ and Cl$^{-}$ separated by distance $r$. Any time two objects---including atoms, ions, molecules, fingers,
...
together or farther apart. If we are talking about small numbers of atoms, ions, and molecules, the
...
be conserved in any process. In this chapter and throughout the book, when we say energy, we are
...
of friction. In these cases, kinetic energy takes on an important role. The potential energy of a generic interaction is given by
...
**valency**. For Na$^+$, $z=1$; for Ca$^{2+}$, $z=2$, and so on. What does it mean to have a negative potential energy? Before answering
...
have negative forces. Note that the convention that *negative force* implies *attractive
...
{"topic": "Van der Waals interactions", "text": """Not all objects are permanently charged like Na$^+$ and Cl$^-$. Even so,
...
separately.
"""}, 
{"topic": "Dipole-dipole forces", "text": """It is clear that if opposite charges attract and like charges repel,
...
$$"""}, 
{"topic": "Hydrogen bonding" , "text": """Hydrogen bonding is a special type of dipole-dipole interaction that
...
{"topic": "Dipole-induced dipole forces", "text": """As its name implies, the dipole-dipole interaction requires both
...
nearby molecule.  A molecule with a permanent
...
$$
"""}, 
{"topic": "London dispersion forces", "text": """The third, final, and in many ways most important part of the van der
...
{"topic": "Dielectric constant", "text": """Each of the expressions are valid
...
denominator."""}, 
{"topic": "Total van der Waals force", "text": """In high school, you probably learned that the van der Waals interaction
...
energies."""}, 
{"topic": "Repulsive intermolecular forces and the Lennard-Jones potential", "text": """The van der Waals forces are quite strong. In fact, in the next chapter,
...
"6-12 potential" termed the **Lennard-Jones potential**, 
...
stretched nor
compressed.]"""}, 
{"topic": "The scale of energies and forces", "text": """This section has been very theoretical so far. However, the expressions
