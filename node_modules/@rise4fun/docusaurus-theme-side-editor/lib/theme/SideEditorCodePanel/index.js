...
export default function SideEditorCodePanel(props) {
    ...
    return (React.createElement("div", { className: styles.outer },
        React.createElement("div", { className: styles.editor },
            React.createElement(Editor, { className: className, language: language, value: value, theme: theme, onChange: handleEditorChange, onMount: handleEditorDidMount })),
        React.createElement("div", { className: styles.buttons },
            React.createElement("button", { type: "button", title: "Run tool", className: clsx(className || 'button button--primary'), onClick: handleClick }, "Run"))));
}
